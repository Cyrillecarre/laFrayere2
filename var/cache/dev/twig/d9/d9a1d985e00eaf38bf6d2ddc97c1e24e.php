...
class __TwigTemplate_3ad575b5f587e50b8812318c2b89de9b extends Template
{
    ...
    protected function doDisplay(array $context, array $blocks = []): iterable
    {
        ...
        yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape($this->extensions['Symfony\Bridge\Twig\Extension\RoutingExtension']->getPath("app_poste_four_delete", ["id" => CoreExtension::getAttribute($this->env, $this->source, (isset($context["poste_four"]) || array_key_exists("poste_four", $context) ? $context["poste_four"] : (function () { throw new RuntimeError('Variable "poste_four" does not exist.', 1, $this->source); })()), "id", [], "any", false, false, false, 1)]), "html", null, true);
        yield "\" onsubmit=\"return confirm('Voulez-vous supprimer cette réservation?');\">
    <input type=\"hidden\" name=\"_token\" value=\"";
        // line 2
        yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape($this->env->getRuntime('Symfony\Component\Form\FormRenderer')->renderCsrfToken(("delete" . CoreExtension::getAttribute($this->env, $this->source, (isset($context["poste_four"]) || array_key_exists("poste_four", $context) ? $context["poste_four"] : (function () { throw new RuntimeError('Variable "poste_four" does not exist.', 2, $this->source); })()), "id", [], "any", false, false, false, 2))), "html", null, true);
        yield "\">
