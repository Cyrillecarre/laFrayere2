...
class __TwigTemplate_5d11243a1499109cb58fdc5e215f245f extends Template
{
    ...
    <table class=\"table\">
        ...
        yield "</td>
                <td>
                    <a href=\"";
        // line 30
        yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape($this->extensions['Symfony\Bridge\Twig\Extension\RoutingExtension']->getPath("app_poste_three_edit", ["id" => CoreExtension::getAttribute($this->env, $this->source, (isset($context["poste_three"]) || array_key_exists("poste_three", $context) ? $context["poste_three"] : (function () { throw new RuntimeError('Variable "poste_three" does not exist.', 30, $this->source); })()), "id", [], "any", false, false, false, 30)]), "html", null, true);
...
";
    ...
    {
        return array (  187 => 40,  182 => 38,  178 => 37,  174 => 36,  165 => 30,  160 => 28,  156 => 27,  152 => 26,  148 => 25,  144 => 24,  128 => 10,  115 => 9,  101 => 6,  88 => 5,  65 => 3,  42 => 1,);
    }
