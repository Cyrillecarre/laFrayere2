...
class getForm_RegistryService extends App_KernelDevDebugContainer
{
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        return $container->privates['form.registry'] = new \Symfony\Component\Form\FormRegistry([new \Symfony\Component\Form\Extension\DependencyInjection\DependencyInjectionExtension(new \Symfony\Component\DependencyInjection\Argument\ServiceLocator($container->getService ??= $container->getService(...), [
            ...
            'App\\Form\\GiftType' => ['privates', 'App\\Form\\GiftType', 'getGiftTypeService', true],
            'App\\Form\\MedailleType' => ['privates', 'App\\Form\\MedailleType', 'getMedailleTypeService', true],
            'App\\Form\\MultiResaType' => ['privates', 'App\\Form\\MultiResaType', 'getMultiResaTypeService', true],
            'App\\Form\\PosteFourType' => ['privates', 'App\\Form\\PosteFourType', 'getPosteFourTypeService', true],
            'App\\Form\\PosteOneType' => ['privates', 'App\\Form\\PosteOneType', 'getPosteOneTypeService', true],
            'App\\Form\\PosteThreeType' => ['privates', 'App\\Form\\PosteThreeType', 'getPosteThreeTypeService', true],
            'App\\Form\\PosteTwoType' => ['privates', 'App\\Form\\PosteTwoType', 'getPosteTwoTypeService', true],
            ...
            'App\\Form\\GiftType' => '?',
            'App\\Form\\MedailleType' => '?',
            'App\\Form\\MultiResaType' => '?',
            'App\\Form\\PosteFourType' => '?',
            'App\\Form\\PosteOneType' => '?',
            'App\\Form\\PosteThreeType' => '?',
            'App\\Form\\PosteTwoType' => '?',
