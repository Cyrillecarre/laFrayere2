...
return [
    ...
    'app_gift' => [[], ['_controller' => 'App\\Controller\\GiftController::index'], [], [['text', '/gift']], [], [], []],
    'app_gift_payment_page' => [['id'], ['_controller' => 'App\\Controller\\GiftController::paymentPage'], [], [['variable', '/', '[^/]++', 'id', true], ['text', '/gift/payment-page']], [], [], []],
    'app_gift_payment' => [['id'], ['_controller' => 'App\\Controller\\GiftController::payment'], [], [['variable', '/', '[^/]++', 'id', true], ['text', '/gift/payment']], [], [], []],
    'app_gift_payment_success' => [['id'], ['_controller' => 'App\\Controller\\GiftController::paymentSuccess'], [], [['variable', '/', '[^/]++', 'id', true], ['text', '/gift/payment/success']], [], [], []],
    'app_gift_payment_cancel' => [['id'], ['_controller' => 'App\\Controller\\GiftController::paymentCancel'], [], [['variable', '/', '[^/]++', 'id', true], ['text', '/gift/payment/cancel']], [], [], []],
    'app_medaille_index' => [[], ['_controller' => 'App\\Controller\\MedailleController::index'], [], [['text', '/medaille']], [], [], []],
    'app_medaille_new' => [[], ['_controller' => 'App\\Controller\\MedailleController::new'], [], [['text', '/medaille/new']], [], [], []],
    'app_medaille_show' => [['id'], ['_controller' => 'App\\Controller\\MedailleController::show'], [], [['variable', '/', '[^/]++', 'id', true], ['text', '/medaille']], [], [], []],
    'app_medaille_edit' => [['id'], ['_controller' => 'App\\Controller\\MedailleController::edit'], [], [['text', '/edit'], ['variable', '/', '[^/]++', 'id', true], ['text', '/medaille']], [], [], []],
    'app_medaille_delete' => [['id'], ['_controller' => 'App\\Controller\\MedailleController::delete'], [], [['variable', '/', '[^/]++', 'id', true], ['text', '/medaille']], [], [], []],
    ...
    'App\Controller\GiftController::index' => [[], ['_controller' => 'App\\Controller\\GiftController::index'], [], [['text', '/gift']], [], [], []],
    'App\Controller\GiftController::paymentPage' => [['id'], ['_controller' => 'App\\Controller\\GiftController::paymentPage'], [], [['variable', '/', '[^/]++', 'id', true], ['text', '/gift/payment-page']], [], [], []],
    'App\Controller\GiftController::payment' => [['id'], ['_controller' => 'App\\Controller\\GiftController::payment'], [], [['variable', '/', '[^/]++', 'id', true], ['text', '/gift/payment']], [], [], []],
    'App\Controller\GiftController::paymentSuccess' => [['id'], ['_controller' => 'App\\Controller\\GiftController::paymentSuccess'], [], [['variable', '/', '[^/]++', 'id', true], ['text', '/gift/payment/success']], [], [], []],
    'App\Controller\GiftController::paymentCancel' => [['id'], ['_controller' => 'App\\Controller\\GiftController::paymentCancel'], [], [['variable', '/', '[^/]++', 'id', true], ['text', '/gift/payment/cancel']], [], [], []],
    'App\Controller\HomeController::index' => [[], ['_controller' => 'App\\Controller\\HomeController::index'], [], [['text', '/']], [], [], []],
    'App\Controller\MedailleController::index' => [[], ['_controller' => 'App\\Controller\\MedailleController::index'], [], [['text', '/medaille']], [], [], []],
    'App\Controller\MedailleController::new' => [[], ['_controller' => 'App\\Controller\\MedailleController::new'], [], [['text', '/medaille/new']], [], [], []],
    'App\Controller\MedailleController::show' => [['id'], ['_controller' => 'App\\Controller\\MedailleController::show'], [], [['variable', '/', '[^/]++', 'id', true], ['text', '/medaille']], [], [], []],
    'App\Controller\MedailleController::edit' => [['id'], ['_controller' => 'App\\Controller\\MedailleController::edit'], [], [['text', '/edit'], ['variable', '/', '[^/]++', 'id', true], ['text', '/medaille']], [], [], []],
    'App\Controller\MedailleController::delete' => [['id'], ['_controller' => 'App\\Controller\\MedailleController::delete'], [], [['variable', '/', '[^/]++', 'id', true], ['text', '/medaille']], [], [], []],
