 ...
 */
final class Version20240429121220 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE `admin` ADD roles JSON NOT NULL, CHANGE email email VARCHAR(180) NOT NULL');
